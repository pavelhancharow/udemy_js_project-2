    ...
    input.addEventListener('drop', function (e) {
      ...
      if (input.getAttribute('data-upload')) {
        ...
        _toConsumableArray(input.files).forEach(function (file) {
          ...
          Object(_services_requests__WEBPACK_IMPORTED_MODULE_5__["postData"])('assets/server.php', formData).then(function (res) {
            console.log(res);
          });
        });
      }
...
var filter = function filter() {
  ...
  var filterBlock = function filterBlock(btnSelector, markSelector) {
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var api;
      api = item.closest('.popup-design') || item.classList.contains('calc_form') ? path.designer : path.question;
      console.log(api);
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var destroyBtn = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    trigger.forEach(function (item) {
      return item.addEventListener('click', function (e) {
        ...
        document.body.style.cssText = "overflow: hidden; margin-right: ".concat(scroll, "px");
      });
    });
